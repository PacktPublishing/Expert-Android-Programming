 ...
 */
public class PlacesRateAdapter extends RecyclerView.Adapter<PlacesRateAdapter.ViewHolder> {

    private static final String TAG = PlacesRateAdapter.class.getSimpleName();
    Context context;
    MyFont myFont;
    private List<RestaurantItem> list;
    private ClickListener clickListener;

    public PlacesRateAdapter(Context context, List<RestaurantItem> list) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_place_rate, viewGroup, false);
