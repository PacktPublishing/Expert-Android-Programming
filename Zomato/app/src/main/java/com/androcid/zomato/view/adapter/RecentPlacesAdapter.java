...
public class RecentPlacesAdapter extends RecyclerView.Adapter<RecentPlacesAdapter.ViewHolder> {
    ...
    private static final String TAG = RecentPlacesAdapter.class.getSimpleName();
    Context context;
    MyFont myFont;
    private List<String> list;
    private ClickListener clickListener;

    public RecentPlacesAdapter(Context context, List<String> list) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_recent_places, viewGroup, false);
