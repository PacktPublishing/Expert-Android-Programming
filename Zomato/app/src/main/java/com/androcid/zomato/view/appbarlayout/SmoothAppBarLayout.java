...
public class SmoothAppBarLayout extends AppBarLayout {
  ...
  private com.androcid.zomato.view.appbarlayout.base.OnOffsetChangedListener mSyncOffsetListener;
  ...
  private void setSyncOffsetListener(com.androcid.zomato.view.appbarlayout.base.OnOffsetChangedListener syncOffsetListener) {
  ...
  public static class Behavior extends BaseBehavior {
    ...
    protected void onInit(CoordinatorLayout coordinatorLayout, final AppBarLayout child) {
      ...
      if (child instanceof SmoothAppBarLayout) {
        ...
        layout.setSyncOffsetListener(new com.androcid.zomato.view.appbarlayout.base.OnOffsetChangedListener() {
          @Override
